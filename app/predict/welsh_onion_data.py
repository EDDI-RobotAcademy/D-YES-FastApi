...
def send_random_number():
    ...
    data = {"date": datetime.today().strftime('%Y-%m-%d'), "farmProduceName": "welshOnion", "farmProducePrice": random_number}
