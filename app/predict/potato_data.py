...
def get_potato_price():
    ...
    random_number = random.choices(range(14000, 60000), k=14)
    print(random_number)
...
def send_random_number_potato():
    random_number = get_potato_price()
    load_dotenv()
    spring_url = os.getenv('spring')
    api_url = f"{spring_url}/farmProduce/save-potato-price"

    data = {"date": datetime.today().strftime('%Y-%m-%d'), "farmProduceName": "potato",
