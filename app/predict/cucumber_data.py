...
def get_cucumber_price():
    ...
    least_harvest_time = 50
    most_harvest_time = 70
    ...
    qs['p_itemcode'] = '223'          # 오이
    qs['p_kindcode'] = '02'           # 다다기계통
    ...
    random_number = random.choices(range(40000,200000), k=14)
    print(random_number)
...
def send_random_number():
    ...
    api_url = f"{spring_url}/farmProduce/save-cucumber-price"

    data = {"date": datetime.today().strftime('%Y-%m-%d'), "farmProduceName": "cucumber", "farmProducePrice": random_number}
