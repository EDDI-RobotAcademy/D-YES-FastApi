...
def get_carrot_price():
    ...
    qs['p_itemcategorycode'] = '200'  # 채소류
    qs['p_itemcode'] = '232'  # 당근
    qs['p_kindcode'] = '01'  # 무세척
    ...
    random_number = random.choices(range(15000, 20000), k=14)
    print(random_number)
...
def send_random_number_carrot():
    random_number = get_carrot_price()
    load_dotenv()
    spring_url = os.getenv('spring')
    api_url = f"{spring_url}/farmProduce/save-carrot-price"

    data = {"date": datetime.today().strftime('%Y-%m-%d'), "farmProduceName": "carrot",
